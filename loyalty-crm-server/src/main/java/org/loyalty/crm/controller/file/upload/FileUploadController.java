package org.loyalty.crm.controller.file.upload;
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file) {
        if (!file.isEmpty()) {
            try {
               ...
               * 4、文件大小的限制;
               */
                BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream(new File( filesSettings.getHeadurl() + file.getOriginalFilename())));
